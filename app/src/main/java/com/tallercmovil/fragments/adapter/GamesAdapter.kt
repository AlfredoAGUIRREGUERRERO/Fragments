...
import com.tallercmovil.fragments.databinding.GamesElementBinding
...
class GamesAdapter(private val context: Context, val games: ArrayList<Game>, val onItemListener: OnItemListener): RecyclerView.Adapter<GamesAdapter.ViewHolder>() {
    ...
    interface OnItemListener{
        fun miClick(game: Game)
    }

    class ViewHolder(binding: GamesElementBinding, onItemListener: OnItemListener): RecyclerView.ViewHolder(binding.root), View.OnClickListener{
